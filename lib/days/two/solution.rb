      ...
      class << self
        def run_part_one(input)
          ...
          input.split("\n").each_with_index do |row, index|
            ...
            buffer << columns.max - columns.min
          end
          buffer.sum
        end
        ...
        def run_part_two(input)
          ...
          input.split("\n").each_with_index do |row, index|
            columns = row.split(' ').map(&:to_i)
            buffer << obtain_buffer_part_two(columns)
          end
          buffer.sum
        end

        def obtain_buffer_part_two(columns)
          acc = 0
          columns.each_with_index do |current, index|
            columns.each_with_index do |n, i|
              next if index == i
              acc +=  (current % n).zero? ? current / n : 0
            end
          end
          acc
        end

        def exercise_part_one
          ...
          run_part_one(input) # It returns 47623
        end

        def exercise_part_two
          input = "5806 6444  1281  38  267 1835  223 4912  5995  230 4395  2986  6048  4719  216 1201
                  74  127 226 84  174 280 94  159 198 305 124 106 205 99  177 294
                  1332  52  54  655 56  170 843 707 1273  1163  89  23  43  1300  1383  1229
                  5653  236 1944  3807  5356  246 222 1999  4872  206 5265  5397  5220  5538  286 917
                  ...
                  588 345 67  286 743 54  802 776 29  44  107 63  303 372 41  810
                  128 2088  3422  111 3312  740 3024  1946  920 131 112 477 3386  2392  1108  2741"
          run_part_two(input) # It returns 312
        end
      end
    end
  end
